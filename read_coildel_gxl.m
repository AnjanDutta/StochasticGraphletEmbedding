function [vertices,nvertices,atrvertices,edges,nedges,atredges] = read_coildel_gxl(filename)
...
vertices = cell2mat(cellfun(@(x) x(2:3),tokens,'UniformOutput',false)'); clear tokens;
